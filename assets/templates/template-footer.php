...
<section class="footer-area">
    ...
    <div class="container">
        ...
        <div class="row copyright-content align-items-center">
            <div class="col-lg-10">
                <p class="copy__desc">Copyrights &copy; 2003-<?= Date('Y'); ?> <strong style="color:white;">Lakshya Bharati Institute of International Hotel Management.</strong> All rights reserved.
                    <br />
